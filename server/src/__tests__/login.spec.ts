...
import { Company, CompanyDocumentInterface } from "#models/company.model.js";
...
describe("Login API Tests", () => {
    let company: CompanyDocumentInterface;
    ...
    beforeAll(async () => {
        ...
        testUserData = {
            name: "Test User",
            username: "testuser",
            password: await Encrypter.hashPassword("testpassword"),
            phone_no: "9876543210",
    ...
    describe("Failed login scenarios", () => {
        it("should fail with invalid username", async () => {
            await expect(AuthService.login("nonexistentuser", "testpassword"))
                .rejects
                .toThrow("Invalid Credentials, Please check Username and Password");
        });
        ...
        it("should fail when user is inactive", async () => {
            ...
            await expect(AuthService.login("testuser", "testpassword"))
                .rejects
                .toThrow("User is Inactive, Please contact your Admin");
        ...
        it("should fail when company is inactive", async () => {
            ...
            await expect(AuthService.login("testuser", "testpassword"))
                .rejects
                .toThrow("Company is in Inactive state, please contant Our Support Number");
